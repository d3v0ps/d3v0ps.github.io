...
/* harmony import */ var src_app_core_services_highlight_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/highlight.service */ "./src/app/core/services/highlight.service.ts");
/* harmony import */ var _links_list_links_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../links-list/links-list.component */ "./src/app/shared/links-list/links-list.component.ts");
...
class BlogComponent {
    constructor(scully, titleService, highlightService) {
        this.scully = scully;
    ...
    ngOnInit() {
        this.scully.getCurrent()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(data => data ? true : false))
            .subscribe(data => {
...
BlogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BlogComponent, selectors: [["app-blog"]], inputs: { title: "title", blog: "blog" }, decls: 10, vars: 2, consts: [[1, "navbar", "navbar-dark", "bg-dark", "justify-content-between"], [1, "navbar-brand"], [1, "container-fluid", "my-4"], [1, "row"], [1, "col-md-3", "col-12", "mb-2"], [3, "blog"], [1, "col"], [1, "card", "article", "p-4"]], template: function BlogComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_links_list_links_list_component__WEBPACK_IMPORTED_MODULE_5__["LinksListComponent"], _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyContentComponent"]], styles: ["[_ngcontent-%COMP%]::slotted(h1)  {\n        color:rgb(51, 6, 37);\n        background-color: rgb(248, 211, 236);\n        padding: 5px;\n        border-radius: 5px;\n        width: fit-content;\n      }"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlogComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyRoutesService"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Title"] }, { type: src_app_core_services_highlight_service__WEBPACK_IMPORTED_MODULE_4__["HighlightService"] }]; }, { title: [{
...
//# sourceMappingURL=default~atlas-atlas-module~creativeworks-creativeworks-module~infiniteloop-infiniteloop-module~kerne~4ac1317a-es2015.js.map